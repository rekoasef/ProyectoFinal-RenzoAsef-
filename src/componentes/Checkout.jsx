...
const Checkout = () => {
    ...
    const {cart, clearCart, TotalPrecioProductos} = useContext(CartContext);
    ...
    const generarOrden = () => {
        ...
        const items = cart.map(item => ({id:item.identificador, titulo:item.titulo, precio:item.precio}));
        const fecha = new Date();
        const date = `${fecha.getDate()}-${fecha.getMonth()+1}-${fecha.getFullYear()} ${fecha.getHours()}:${fecha.getMinutes()}`;
        const total = TotalPrecioProductos();
    ...
    return (
        <div className="container">
                    ...
                    <table className="table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td className="text-start align-middle">${TotalPrecioProductos()}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div className="row my-5">
                <div className="col text-center">
                    {orderId ? <div class="alert alert-secondary p-5 text-center" role="alert">
